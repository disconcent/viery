    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL2:
            try:
                ...
                self.LOGGER(__name__).warning(
                    f"Pastikan @{self.username} adalah admin di Channel2 Tersebut, Chat ID F-Subs Channel2 Saat Ini: {FORCE_SUB_CHANNEL2}"
                )
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Gabung Group https://t.me/SharingUserbot untuk Bantuan"
                )
        ...
        if FORCE_SUB_CHANNEL3:
            try:
                ...
                self.LOGGER(__name__).warning(
                    f"Pastikan @{self.username} adalah admin di Channel3 Tersebut, Chat ID F-Subs Channel3 Saat Ini: {FORCE_SUB_CHANNEL3}"
                )
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Gabung Group https://t.me/SharingUserbot untuk Bantuan"
                )
